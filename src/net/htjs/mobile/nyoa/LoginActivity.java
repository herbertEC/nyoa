					...
					public void run() {
						...
						try {
							...
							if ("1".equals(i.get("result"))) {
								...
								Util.dialogOnlyCommit(LoginActivity.this, "非法访问", "确定", "取消", null, null, null);
							} else if ("5".equals(i.get("result"))) {
								Util.dialogOnlyCommit(LoginActivity.this, "账户异常", "确定", "取消", null, null, null);
							} else if ("0".equals(i.get("result"))) {
								Util.dialogOnlyCommit(LoginActivity.this, "账户被禁用", "确定", "取消", null, null, null);
							} else if ("3".equals(i.get("result"))) {
								Util.dialogOnlyCommit(LoginActivity.this, "用户名无效", "确定", "取消", null, null, null);
							} else {
								Util.dialogOnlyCommit(LoginActivity.this, "密码错误", "确定", "取消", null, null, null);
							}
							L.C.loginFlag = true;
							...
							Util.dialogOnlyCommit(LoginActivity.this, "登录失败", "确定", "取消", null, null, null);
							e.printStackTrace();
